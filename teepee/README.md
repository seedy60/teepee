...
- Build chat message templates with a guided generator (presets, insert-variable buttons, and live preview) or type variables manually.
...
- Muted chats are not announced through screen reader speech notifications.
...
- Chat message template for the message list:
  You can choose a preset, insert variables with buttons, review the live preview, or type the template directly.
  Variables: [user], [msg], [fname], [ftype], [datetime].
  Example: [user]: [msg], sent [datetime].
